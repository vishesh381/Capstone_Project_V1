  ...
  return <BrowserRouter>
    <div className='relative overflow-hidden'>
      ...
      <Routes>
        ...
        <Route path='/find-jobs' element={<ProtectedRoute allowedRoles={['EMPLOYER','APPLICANT', 'ADMIN']}><FindJobsPage /></ProtectedRoute>} />
        <Route path='/jobs/:id' element={<ProtectedRoute allowedRoles={['EMPLOYER','APPLICANT', 'ADMIN']}><JobPage /></ProtectedRoute>} />
        <Route path='/apply-job/:id' element={<ProtectedRoute allowedRoles={['EMPLOYER','APPLICANT', 'ADMIN']}><ApplyJobPage /></ProtectedRoute>} />
        <Route path='/find-talent' element={<ProtectedRoute allowedRoles={['EMPLOYER', 'ADMIN','APPLICANT']}><FindTalentPage /></ProtectedRoute>} />
        <Route path='/talent-profile/:id' element={<ProtectedRoute allowedRoles={['EMPLOYER', 'ADMIN','APPLICANT']}><TalentProfilePage /></ProtectedRoute>} />
        <Route path='/company/:name' element={<ProtectedRoute allowedRoles={['APPLICANT', 'ADMIN']}><CompanyPage /></ProtectedRoute>} />
        <Route path='/job-history' element={<ProtectedRoute allowedRoles={['EMPLOYER','APPLICANT', 'ADMIN']}><JobHistoryPage /></ProtectedRoute>} />
